...
describe("ONP-008 image alt", () => {
  it("passes when images have alt text (or empty alt for decoration)", async () => {
    const body = '<img src="/images/blue-mug.svg" alt="Blue mug"><img src="/images/divider-line.svg" alt="">';
  ...
  it("fails for an image without an alt attribute", async () => {
    const pages = { ...defaultPages(), "/about/": page("/about/", { body: '<img src="/images/blue-mug.svg">' }) };
