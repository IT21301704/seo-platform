...
export const SD_002 = defineRule(
  {
    ...
    passCondition:
      "Passes when the home page has an Organization (or LocalBusiness) item with name, url and logo or image.",
    appliesTo: "both",
    autoFixable: true,
    riskLevel: "high",
    effort: 2,
    explanation: {
      ...
      fix: [
        "Fill in the organization/business details in your SEO plugin (name, logo, social profiles).",
      ],
    },
  },
  (site) => {
    ...
    return [
      fail(site.rootUrl, {
        found: orgs.length,
        problem: orgs.length ? "missing name, url or logo" : "no Organization",
      }),
    ];
  },
);
